   ...
   public  class FittingsClient
    {
        ...
        {
            var request = RestRequestHelper.CreateAuthrorizedRestRequest($"characters/{characterId}/fittings/", Method.GET, authtoken);
        ...
        {
            var request = RestRequestHelper.CreateAuthrorizedRestRequest($"characters/{characterId}/fittings/", Method.POST, authToken);
        ...
        {
            var request = RestRequestHelper.CreateAuthrorizedRestRequest($"characters/{characterId}/fittings/{fittingId}", Method.DELETE, authToken);
